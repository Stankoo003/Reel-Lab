...
public abstract class ApiIntegrationTest {
    ...
    void truncateEverything() {
        // Named rather than left to CASCADE: user_follows and password_resets would both be
        // reached through users anyway, but a table nobody names is a table nobody notices
        // has stopped being emptied.
